    ...
    <div className="bg-white">
      ...
      <section className="relative flex min-h-screen items-center overflow-hidden">
        ...
        <div className="relative mx-auto w-full max-w-6xl px-6 py-28 sm:px-10">
          <div className="max-w-xl text-ivoire animate-fade-in-up">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/signup"
                className="inline-flex items-center gap-2 rounded-xl2 bg-or px-6 py-3.5 font-medium text-cacao shadow-soft transition duration-250 ease-soft hover:bg-or-clair active:scale-[0.98]"
              >
              ...
              <a
                href="#gains"
                className="inline-flex items-center gap-2 rounded-xl2 border border-ivoire/40 px-6 py-3.5 font-medium text-ivoire transition duration-250 ease-soft hover:bg-ivoire/10"
              >
      ...
      >
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2">
          {/* 6 mois */}
          <Reveal>
            <div className="rounded-4xl border border-sable bg-rose/20 p-7">
              ...
              <div className="mt-6 rounded-xl2 bg-white p-5">
          ...
          {/* 1 an */}
          <Reveal delay={120}>
            <div className="rounded-4xl border border-cacao/10 bg-cacao p-7 text-ivoire">
              <span className="inline-block rounded-full bg-or px-3 py-1 text-xs font-semibold uppercase tracking-wider text-cacao">
                À 1 an
              </span>
              ...
              <div className="mt-6 rounded-xl2 bg-or p-5 text-cacao">
        ...
        <Reveal>
          <h3 className="mt-16 font-display text-2xl text-cacao md:text-3xl">
            ...
            <span className="italic text-or">concrètement</span>
          </h3>
        </Reveal>
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          {CONCRET.map((c, i) => (
            <Reveal key={c.montant} delay={i * 90}>
              <div className="flex h-full flex-col rounded-3xl border border-sable bg-white p-6 shadow-soft transition duration-250 ease-soft hover:-translate-y-0.5 hover:shadow-card">
                ...
                <p className="mt-5 rounded-xl2 bg-rose/30 px-4 py-3 text-sm font-medium text-cacao">
                  {c.exemple}
                </p>
              </div>
            </Reveal>
      ...
      <section className="mx-auto max-w-6xl px-6 py-28 sm:px-10 md:py-36">
        ...
        {/* Important */}
        <Reveal>
          <div className="mt-14 rounded-3xl border border-or/40 bg-rose/20 p-6">
            ...
            <p className="mt-2 text-cacao/80">
              ...
              gagnes dépend de ton talent, de ta disponibilité et de ton
              sérieux.
            </p>
          </div>
        </Reveal>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-3xl px-6 py-28 text-center text-ivoire md:py-36">
          <Reveal>
            ...
            <Link
              href="/signup"
              className="mt-8 inline-flex items-center gap-2 rounded-xl2 bg-or px-7 py-3.5 font-medium text-cacao shadow-soft transition duration-250 ease-soft hover:bg-or-clair active:scale-[0.98]"
            >
              Créer mon profil Zuriste
              <ArrowRight className="h-4 w-4" aria-hidden />
            </Link>
